    ...
    <aside className="w-72 flex-shrink-0 flex flex-col gap-6">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-5 flex flex-col h-full min-h-[calc(100vh-6rem)] sticky top-24">
        ...
        <nav className="flex flex-col gap-2 flex-grow">
          ...
          <NavLink to="/admin/dashboard/chat" className={getNavLinkClass}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {user?.role === 'admin' && (
            <NavLink to="/admin/dashboard/staff" className={getNavLinkClass}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {user?.role === 'admin' && (
            <NavLink to="/admin/dashboard/transactions" className={getNavLinkClass}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <NavLink to="/admin/dashboard/profile" className={getNavLinkClass}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
